...
UPDATE utilisateur SET points=200 WHERE id_user = "2";DROP TABLE IF EXISTS `seche_linge`;
CREATE TABLE IF NOT EXISTS `seche_linge` (id_seche_linge INT PRIMARY KEY AUTO_INCREMENT, `mode eco` BOOLEAN, `nom` VARCHAR(255), `id_connection` VARCHAR(255), `nom_salle` VARCHAR(255), `fonctionnement` BOOLEAN, `conso_en` FLOAT);

DROP TABLE IF EXISTS `seche_linge22`;
CREATE TABLE IF NOT EXISTS `seche_linge22` (id_seche_linge22 INT PRIMARY KEY AUTO_INCREMENT, `source_tv` VARCHAR(255), `conso_en` FLOAT, `nom` VARCHAR(255), `id_connection` VARCHAR(255), `nom_salle` VARCHAR(255), `fonctionnement` BOOLEAN);

DROP TABLE IF EXISTS `téléviseur`;
CREATE TABLE IF NOT EXISTS `téléviseur` (id_téléviseur INT PRIMARY KEY AUTO_INCREMENT, `chaine` FLOAT, `volume` FLOAT, `conso_en` FLOAT, `nom` VARCHAR(255), `id_connection` VARCHAR(255), `nom_salle` VARCHAR(255), `fonctionnement` BOOLEAN);

DROP TABLE IF EXISTS `alexa`;
CREATE TABLE IF NOT EXISTS `alexa` (id_alexa INT PRIMARY KEY AUTO_INCREMENT, `volume` FLOAT, `conso_en` FLOAT, `nom` VARCHAR(255), `id_connection` VARCHAR(255), `nom_salle` VARCHAR(255), `fonctionnement` BOOLEAN);
