...
if (isset($_POST['ajouter'])) {
    $stmt = $pdo->prepare("INSERT INTO utilisateur (
        ...
        statut, code_validation, verifie, role
    ) VALUES (
        :pseudonyme, :age, :gender, :dateNaissance, :avatar, :email,
        :last_name, :first_name, :mot_de_passe, :points,
        :statut, :code_validation, :verifie, :role
...
<form method="POST">
    ...
    <select name="role" required>
        ...
        <option value="connecte">Utilisateur</option>
        <option value="intermediaire">Enfant</option>
        <option value="avanceps">Voisin</option>
    </select>
