...
CREATE TABLE IF NOT EXISTS historique (
    ...
    id_utilisateur INT DEFAULT NULL,  -- clé étrangère vers `utilisateur.id_user`
...
INSERT INTO aspirateur(programme, temps_restant, fonctionnement, nom_salle) values ('eco', 10, FALSE, 'salmanger');
